...
WebDriverManager.chromedriver().setup();  
	...
	WebElement editLeadElement1 = driver.findElement(By.linkText("Edit"));
	editLeadElement1.click();
	
	WebElement cleardescriptionElement = driver.findElement(By.name("description"));
	cleardescriptionElement.clear();
	
	WebElement importantnoteElement = driver.findElement(By.id("updateLeadForm_importantNote"));
	importantnoteElement.sendKeys("its important");
	
	WebElement updateLeadElement1 = driver.findElement(By.name("submitButton"));
	updateLeadElement1.click();
