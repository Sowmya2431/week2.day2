...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		WebElement duplicateLeadElement1 = driver.findElement(By.linkText("Duplicate Lead"));
		duplicateLeadElement1.click();
		
		
		WebElement clearCompanyNameElement = driver.findElement(By.name("description"));
		clearCompanyNameElement.clear();
		
		WebElement companyNameElement1 = driver.findElement(By.id("createLeadForm_companyName"));
		companyNameElement1.sendKeys("Amazon");
		
		WebElement clearfirstNameElement = driver.findElement(By.id("createLeadForm_firstName"));
		clearfirstNameElement.clear();
		
		WebElement firstNameElement1 = driver.findElement(By.id("createLeadForm_firstName"));
		firstNameElement1.sendKeys("Arjun");
